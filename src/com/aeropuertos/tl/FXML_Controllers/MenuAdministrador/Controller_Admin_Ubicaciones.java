...
public class Controller_Admin_Ubicaciones implements Initializable {
    ...
    ObservableList<Ubicacion> datos = FXCollections.observableArrayList();
    ...
    void abrirFormularioRegistro(ActionEvent event){
        try{
            ...
            AnchorPane root = FXMLLoader.load(getClass().getResource("../../../ui/FXML/Registrar_Ubicacion.fxml"));
